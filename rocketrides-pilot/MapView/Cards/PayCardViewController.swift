...
class PayCardViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        collectPaymentLabel.text = "Collect payment from Stalwart IT Solution"
        collectPaymentLabel.font = UIFont.systemFont(ofSize: 12)
        collectPaymentLabel.textColor = .secondaryLabel
        
        collectPaymentAmount.textColor = .label
        collectPaymentAmount.font = UIFont.systemFont(ofSize: 22, weight: .medium)
